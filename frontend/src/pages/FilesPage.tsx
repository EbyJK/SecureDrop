  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-slate-950">
      ...
      <main className="p-6 space-y-6 max-w-7xl w-full mx-auto">
        ...
        {loading ? (
          <div className="py-20 text-center text-slate-500 text-sm">Loading files...</div>
        ) : items.length > 0 ? (
          ...
          <div className="bg-slate-900/50 border border-slate-800/80 rounded-2xl p-16 text-center">
            ...
            <p className="text-slate-200 font-bold text-base">No files uploaded yet</p>
            <p className="text-slate-500 text-xs mt-1">
              Upload files from the web dashboard or forward documents/photos to your Telegram bot.
            </p>
          </div>
        )}
      </main>
      ...
      <ItemDetailModal
        ...
        onItemUpdated={fetchFiles}
        onItemDeleted={fetchFiles}
      />
    </div>
  );
};
